  ...
  return (
    <div className="fixed inset-0 z-[2000] bg-black/90 backdrop-blur-2xl">
      <div className="absolute top-8 left-1/2 -translate-x-1/2 z-[2001] w-full px-6 flex justify-between items-center">
        ...
        <div className="px-6 py-2 rounded-full bg-primary/20 backdrop-blur-md border border-primary/30 text-primary text-[10px] font-bold tracking-[0.3em] uppercase">
          Live AR Session
        </div>
